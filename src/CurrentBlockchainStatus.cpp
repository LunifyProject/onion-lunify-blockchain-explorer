...
CurrentBlockchainStatus::load_current_emission_amount()
{
    ...
    string last_saved_emmision = lfieg::read(emmision_saved_file);
...
bf::path CurrentBlockchainStatus::blockchain_path {"/home/mwo/.Lunify/lmdb"};
...
string CurrentBlockchainStatus::daemon_url {"http:://127.0.0.1:25252"};
...
lfieg::MicroCore*  CurrentBlockchainStatus::mcore {nullptr};
}
