...
MempoolStatus::read_mempool()
{
    ...
    for (size_t i = 0; i < mempool_tx_info.size(); ++i)
    {
        ...
        double payed_for_kB = LFI_AMOUNT(_tx_info.fee) / tx_size;
...
bf::path MempoolStatus::blockchain_path {"/home/mwo/.Lunify/lmdb"};
string MempoolStatus::daemon_url {"http:://127.0.0.1:25252"};
...
lfieg::MicroCore*  MempoolStatus::mcore {nullptr};
